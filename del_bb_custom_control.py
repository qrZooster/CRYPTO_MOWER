# ======================================================================================================================
# 📁 file        : bb_custom_control.py — Базовый визуальный компонент и фундамент UI (заготовка)
...
class TCustomControl(TComponent):
    ...
    def add_control(self, ctrl: "TCustomControl"):
        """Добавляет дочерний контрол в дерево."""
    ...
    def add_class(self, classes: str | None):
        """Добавляет классы в корневой тег без дублей."""
        if not classes:
            return
    ...
    def render_children(self):
        """Отрисовывает всех дочерних контролов через их _render() и вносит их Canvas в текущий Canvas."""
    ...
    def render(self):
        """Создаёт DOM-дерево: по умолчанию просто оборачивает детей (render_children). Переопределяй в потомках."""
    ...
    def release_children(self):
        """Мягко высвобождает всех детей без прямого free(): снимает их с Owner, чистит структуры Controls/Canvas."""
        ...
        self.Canvas.clear()
        # ... 🔊 ...
        self.log("release_children", f"{self.Name} children released")
    # ..................................................................................................................
    # 🔰 mark* methods
    # ..................................................................................................................
...
# ----------------------------------------------------------------------------------------------------------------------
# 🧩 TControl — базовый визуальный контейнерный контрол (старое имя сохранено для совместимости)
# ----------------------------------------------------------------------------------------------------------------------
class TControl(TCustomControl):
    ...
    def __init__(self, Owner=None, Name: str | None = None):
        ...
        """
        super().__init__(Owner, Name)
        self.log("__init__", f"⚙️ control {self.Name} created uid={self.uid}")
# ----------------------------------------------------------------------------------------------------------------------
# 🧩 TFlex_Tr — гибкая "строка панели" (flex-row контейнер для TFlex_Td)
# ----------------------------------------------------------------------------------------------------------------------
class TFlex_Tr(TControl):
    prefix = "flex_tr"
    # ⚡🛠️ ▸ __init__
...
class TFlex_Td(TControl):
    ...
    def __init__(self, Owner: "TFlex_Tr", Name: str | None = None):
        ...
        #   • TControl → будет отрисован отдельно и влит внутрь td
    ...
    def _mark_level(self) -> int:
        ...
        panel.level=0 → td.level=1 (фиолетовые рамки отдельно от grid).
...
# ======================================================================================================================
# 📁🌄 bb_custom_control.py 🜂 The End — See You Next Session 2025 💹 Tradition Core 2025.10 671 -> 911
# ======================================================================================================================
