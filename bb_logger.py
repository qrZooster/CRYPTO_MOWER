# ======================================================================================================================
# 📁 file        : bb_logger.py — Rich LogRouter для Tradition Core 2025
# 🕒 created     : 13.10.2025 00:00
# 🎉 contains    : TLogRouter (Rich-консоль), TLogRouterMixin, LoggableComponent, init_log_router/LOG_ROUTER
...
# ----------------------------------------------------------------------------------------------------------------------
# 🧩 TLogRouter — Глобальный Rich лог-центр с несколькими окнами
# ----------------------------------------------------------------------------------------------------------------------
class TLogRouter:
...
def init_log_router():
    ...
    return LOG_ROUTER
# ----------------------------------------------------------------------------------------------------------------------
# 🧩 TLogRouterMixin — Миксин для прямого доступа к LOG_ROUTER
# ----------------------------------------------------------------------------------------------------------------------
...
# ----------------------------------------------------------------------------------------------------------------------
# 🧩 LoggableComponent — Базовый миксин централизованного логгирования
# ----------------------------------------------------------------------------------------------------------------------
class LoggableComponent:
    ...
    def log(self, function: str, *parts, window: int = 1):
        ...
        try:
            ...
            print(text, flush=True)
# ======================================================================================================================
# 📁🌄 bb_logger.py 🜂 The End — See You Next Session 2025 💹 Tradition Core 2025.10
# ======================================================================================================================
