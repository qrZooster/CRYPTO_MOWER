...
# --- Параметры сглаживания/детектора ---
COOL = 5             # период охлаждения: к окнам 20/50/100 прибавим +COOL
...
MIN_BASELINE_VOL = 1e-9 # защита от деления на ноль/очень малых baseline # защита от деления на ноль/очень малых baseline
...
# helper: берём ровно N значений, пропуская последние COOL
...
def _finalize_candle(symbol: str, c: dict):
    ...
    c["AVG_V_50"] = avg50
    c["AVG_V_100"] = avg100
    # кратность объёма к средним (целые числа)
